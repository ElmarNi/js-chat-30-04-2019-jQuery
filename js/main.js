$(document).ready(function () {
    ...
    $(document).on("click", ".right-div img", function () { toggleSelected(this) })
    $(document).on("click", ".left-div img", function () { toggleSelected(this) })
...
function replyUploader() { 
    let replyArr = []
    let inputValue = $(".inputs input").val();
    let reply = $("<div></div>");
